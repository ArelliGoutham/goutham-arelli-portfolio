export const experience = [
  {
    ...
    focus: "High-throughput EMI systems, observability, service reliability, and enterprise P3P SDKs for agentic payments.",
    stack: ["Kotlin", "Java", "TypeScript", "Python", "Microservices", "OpenTelemetry", "P3P"],
    bullets: [
      ...
      "Owned enterprise-ready TypeScript and Python client/server SDKs for Pine Labs P3P (agentic payments over x402 and UPI ReservePay), including auth, capture flows, and Grantex spend controls.",
